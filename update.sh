...
run_update() {
    ...
    wget -qO- fv-tunnel "https://raw.githubusercontent.com/hokagelegend/alpha-v3/refs/heads/main/config/fv-tunnel" 
    chmod +x fv-tunnel 
    bash fv-tunnel
    rm -rf fv-tunnel
    ...
    wget https://raw.githubusercontent.com/hokagelegend/alpha-v3/refs/heads/main/menu/menu.zip
    ...
    wget -q -O /usr/local/sbin/menu https://raw.githubusercontent.com/hokagelegend/alpha-v3/refs/heads/main/menu/menu
